...
pygame.display.set_caption("EGG CATCHER GAME")      #SET A CAPTION FOR WINDOW
    ...
    while run:
        ...
        if showScreen : 
            ...
            if Y1_spatch and Y1 < 200:
                SCREEN.blit(spatch,(140,480))
            if Y2_spatch and Y2 < 200:
                SCREEN.blit(spatch,(400,480))
            if Y3_spatch and Y3 < 200:
                print(Y4)
                SCREEN.blit(spatch,(650,480))
            if Y4_spatch and Y4 < 200:
                SCREEN.blit(spatch,(870,480))
